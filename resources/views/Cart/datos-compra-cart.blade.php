    ...
    <div class="row d-flex justify-content-center">
        ...
        <div class="card" style="width: 18rem;">
          ...
          <ul class="list-group list-group-flush">
            ...
            @endforeach 
            <li class="list-group-item text-center">Total: ${{Cart::getSubTotal()}}</li>
          </ul>
        ...
        <div class="card border-0">
            <div class="card-body">
                <form action="{{url('info-store')}}" method="POST" class="needs-validation" novalidate>
                  @csrf


                    <input name="producto" type="hidden" value=" @foreach (Cart::getContent()->sortBy(function ($cart) {return $cart->id;}); as $item)

                                                                      {{ $item->name }} x {{ $item->quantity }} = {{$item->price*$item->quantity}}
                                                                  @endforeach">
                    
                    <input name="precio" type="hidden" value="{{Cart::getSubTotal()}}">
